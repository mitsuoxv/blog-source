...
This happens because I assume that productivity stops to grow from Period 5 when Generation 6 works, and that population Reproduce rate over Generation by Generation 4 and 5 is less than 1.
