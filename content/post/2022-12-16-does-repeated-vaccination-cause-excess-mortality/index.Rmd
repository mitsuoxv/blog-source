...
## Vaccine shots and excess deaths in Japan (Added on 2022-12-30)
...
## Two estimates of excess deaths by The Economist and World Mortality Dataset (WMD) (Added on 2022-12-30)
...
There are two estimates of excess deaths by The Economist and World Mortality Dataset (WMD). So far I use the Economist, which estimates more excess deaths than WMD.

```{r two_estimates, message=FALSE, warning=FALSE}
bind_rows(
